...
def run_mp(map_func, arg_list, combine_func=None, num_cores=-1, split_arg=-1, progress_bar=False, **kwargs):
...
if __name__ == "__main__":
    ...
    print(run_mp(add_num, args_list, combine_func=sum, progress_bar=True, num_cores=10, b=10))
